  ...
  return (
    <section className="py-24 bg-[var(--color-secondary)] transition-colors duration-500">
      <div className="max-w-5xl mx-auto px-6 text-center space-y-6">
        {/* Section Title */}
        <Reveal>
          <h2 className="text-4xl md:text-5xl font-bold text-[var(--color-foreground)] transition-colors duration-500">
        ...
        {/* Description */}
        <Reveal delay={0.1}>
          <div className="text-lg md:text-xl text-[var(--color-foreground)]/90 space-y-3 transition-colors duration-500">
